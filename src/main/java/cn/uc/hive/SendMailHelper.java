...
public class SendMailHelper {
	...
	// SMTP邮件服务器
	private final static String HOST = "mail.ucweb.com";
	...
	private final static String from = "hadoop@ucweb.com";
	
	private final static String user = "hadoop";
	
	public static void sendTextEmail(String passwd,String to,String subject,String text) throws Exception{
		...
		sendTextEmail(props,user,passwd,from,to,subject,text);
	}
	
	/**
	 * 发送简单的文本邮件
	 */
	public static void sendTextEmail(Properties props,String user,String passwd,
	...
	static public void main(String[] args){
		try {
			sendTextEmail("","qiujw@ucweb.com","title","text");
		} catch (Exception e) {
